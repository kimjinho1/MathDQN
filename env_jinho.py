...
class Env:
    ...
    def val_step(self, action_op, loc):
        next_states, done, flag, node1, node2, DQN_answer, gold_answer, etime = self.curr_agent.compound_two_nodes_predict(action_op, loc, './predict/analysis_')
        return next_states, done, flag, node1, node2, DQN_answer, gold_answer, etime
